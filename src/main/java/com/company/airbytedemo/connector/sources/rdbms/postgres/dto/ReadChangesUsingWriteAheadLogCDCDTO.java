...
import com.company.airbytedemo.connector.sources.rdbms.postgres.enums.LSNCommitBehaviour;
import com.company.airbytedemo.connector.sources.rdbms.postgres.enums.Plugin;
...
public class ReadChangesUsingWriteAheadLogCDCDTO {
    ...
    public Plugin getPlugin() {
        return plugin == null ? null : Plugin.fromId(plugin);
    }

    public void setPlugin(Plugin plugin) {
        this.plugin = plugin == null ? null : plugin.getId();
    }
